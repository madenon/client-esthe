export const jobOffers = [
  ...
  description: "Coiffeuse sanchant faire la Coiffure onglerie et maquillage recherche gerance libre adjame ou environ contacrt ", 
    location: "Abidjan", 
    salary: "100.000 FCFA",
  ...
  description: "Categorie coiffure. Zone abidjan avec dortoire   coiffeur   pros recherche travail  texte Coiffure homme, dame,dread locks, curly.", 
    location: "Abidjan", 
    salary: "100.000 FCFA",
    whatsapp: "2250596132058", 
  ...
  },
   {
    ...
    zone: "Abidjan", 
    category: "Coiffeur", 
    title: "Cherche Coiffure onglerie et maquillage goorco ", 
  description: "Tu es une coiffeuse tu recherche sous location ou gerance dans la zone d'adjame ou environ goorco.com Coiffure onglerie et maquillage goorco   : Pas trop cher svp", 
    location: "Abidjan", 
    salary: "",
    whatsapp: "2250596132058", 
    number: "+225 0768515338", 
    likes: 804,
    isUrgent: true,
    isFavorite: false,
    hasDortoir: false,
