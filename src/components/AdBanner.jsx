...
const AdBanner = () => {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[2.5rem] bg-[#0f172a] p-8 md:p-12 shadow-2xl border border-slate-800 min-h-[400px] md:min-h-[320px] flex items-center">
